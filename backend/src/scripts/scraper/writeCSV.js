...
import { createObjectCsvWriter as createCsvWriter, createObjectCsvStringifier as createCsvStringifier } from 'csv-writer';
...
export const saveFile = async (records, title, outputPath) => {
